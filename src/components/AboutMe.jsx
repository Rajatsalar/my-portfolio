        ...
        <div className="about-card">
          <div className="about-content">
            ...
            <div className="about-text">
              ...
              <p>
                With <strong>2 years of hands-on experience at Zoruk EV Pvt. Ltd.</strong>, I have played a key role in maintaining and developing their flagship website, <a href="https://zorukev.com">zorukev.com</a>. My work there sharpened my skills in web technologies and front-end development, where I transformed complex design concepts into user-friendly digital experiences. This role also allowed me to perfect my abilities in creating responsive layouts, optimizing user interfaces, and ensuring seamless performance across various devices, leveraging technologies such as <strong>React.js, Bootstrap, and JavaScript</strong>.
              </p>
              <p>
